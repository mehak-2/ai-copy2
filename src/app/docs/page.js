...
export default function DocsPage() {
    ...
    const CodeBlock = ({ children, id, title }) => (
        <div className="relative bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
            {title && (
                <div className="px-4 py-2 text-sm text-gray-600 border-b border-gray-200 bg-gray-100">
                    {title}
                </div>
            )}
            <div className="relative">
                <pre className="p-4 text-sm text-gray-900 overflow-x-auto font-mono">
                    <code>{children}</code>
                </pre>
                <button
                    onClick={() => copyToClipboard(children, id)}
                    className="absolute top-3 right-3 p-1.5 rounded hover:bg-gray-200 transition-colors"
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="pt-32 pb-20">
                <div className="max-w-4xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <FileText className="w-8 h-8 text-gray-400 mx-auto mb-6" />
            ...
            <div className="max-w-4xl mx-auto px-6 pb-20">
                <div className="space-y-16">
                    ...
                    {/* What You'll Need */}
                    <section>
                        <h2 className="text-2xl font-light text-gray-900 mb-8">What You'll Need</h2>
                        <div className="space-y-4">
                            <p className="text-gray-600">Website admin access or ability to edit template files</p>
                            <p className="text-gray-600">A text editor or built-in CMS editor</p>
                            <p className="text-gray-600">Access to your Axto.ai Web Admin Panel for the script snippet</p>
                        </div>
                    </section>

                    {/* Quick Start */}
                    <section>
                        <h2 className="text-2xl font-light text-gray-900 mb-8">Quick Start</h2>
                        <p className="text-gray-600 mb-8">Ideal if your site uses a shared header or footer template.</p>

                        <div className="space-y-8">
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 mb-4">1. Locate the shared template</h3>
                            ...
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 mb-4">2. Paste the snippet</h3>
                                <div className="text-gray-600 space-y-2">
                            ...
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 mb-4">3. Save and publish</h3>
                                <div className="text-gray-600 space-y-2">
                            ...
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 mb-4">4. Verify</h3>
                                <div className="text-gray-600 space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-gray-900 mb-8">Platform-Specific Instructions</h2>

                        <div className="space-y-12">
                            {/* WordPress */}
                            <div>
                                <h3 className="text-xl font-medium text-gray-900 mb-6">WordPress</h3>

                                <div className="space-y-6">
                                    <div>
                                        <h4 className="font-medium text-gray-800 mb-3">Via Theme Editor</h4>
                                    ...
                                    <div>
                                        <h4 className="font-medium text-gray-800 mb-3">Via Plugin</h4>
                                        <ol className="text-gray-600 space-y-1 list-decimal list-inside">
                                    ...
                                    <div>
                                        <h4 className="font-medium text-gray-800 mb-3">Via functions.php</h4>
...
add_action('wp_head', 'add_axto_widget');`}
                            ...
                            {/* Shopify */}
                            <div>
                                <h3 className="text-xl font-medium text-gray-900 mb-6">Shopify</h3>
                                <ol className="text-gray-600 space-y-1 list-decimal list-inside">
                            ...
                            {/* Static HTML Sites */}
                            <div>
                                <h3 className="text-xl font-medium text-gray-900 mb-6">Static HTML Sites</h3>
                                <ol className="text-gray-600 space-y-1 list-decimal list-inside">
                            ...
                            {/* Other CMS */}
                            <div>
                                <h3 className="text-xl font-medium text-gray-900 mb-6">Other CMS (Drupal, Joomla, etc.)</h3>
                                <div className="text-gray-600 space-y-2">
                            ...
                            {/* Google Tag Manager */}
                            <div>
                                <h3 className="text-xl font-medium text-gray-900 mb-6">Google Tag Manager</h3>
                                <ol className="text-gray-600 space-y-1 list-decimal list-inside">
                    ...
                    {/* No Shared Template */}
                    <section>
                        <h2 className="text-2xl font-light text-gray-900 mb-8">What If There's No Shared Template?</h2>
                        <div className="space-y-4">
                            ...
                            <div className="bg-blue-50 border-l-2 border-blue-200 p-4 rounded-r">
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-gray-900 mb-8">Verifying Installation</h2>
