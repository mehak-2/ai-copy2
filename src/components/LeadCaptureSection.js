                ...
                >
                    <div className="text-center">
                        ...
                        <motion.div
                            ...
                            className="inline-flex items-center justify-center w-12 h-12 bg-blue-50 dark:bg-blue-950/50 rounded-xl mb-8"
                        >
                        ...
                        >
                            {!isSubmitted ? (
                                <motion.div
                                    layout
                                    className="bg-white/90 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg shadow-black/5 dark:shadow-black/20 border border-gray-300/30 dark:border-gray-600/30"
                                >
                                ...
                                <motion.div
                                    ...
                                    className="bg-green-50/70 dark:bg-green-950/30 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-green-200/30 dark:border-green-800/30 shadow-lg shadow-green-500/5"
                                >
                                    <div className="text-center">
                                        <motion.div
                                            ...
                                            className="inline-flex items-center justify-center w-12 h-12 bg-green-100 dark:bg-green-900/50 rounded-xl mb-6"
                                        >
                                        ...
                                        <motion.p
                                            ...
                                            className="text-gray-800 dark:text-gray-200 mb-6 font-light"
                                        >
