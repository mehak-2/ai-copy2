...
const LogoMarquee = () => {
    ...
    return (
        <section className="py-9 md:py-12 bg-white lg:py-16  overflow-hidden">
                ...
                <div className="relative w-full overflow-hidden">
                    <div className="flex space-x-8 animate-marquee">
                        {companies.map((company, index) => (
                            ...
                            >
                                <div className="w-full h-full bg-white/90  backdrop-blur-sm rounded-xl border border-gray-300  p-4 flex items-center justify-center hover:bg-gray-100  transition-all duration-300 shadow-sm hover:shadow-md">
                                    <div className="relative w-full h-full flex items-center justify-center">
                                        <Image
                                            ...
                                            width={80}
                                            height={40}
                                            className="object-contain w-auto h-8 filter  transition-all duration-300"
                                            style={{
